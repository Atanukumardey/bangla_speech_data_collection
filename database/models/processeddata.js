...
const initProcessedData = (sequelize, DataTypes) => {
  class ProcessedData extends Model {
    ...
    static associate(models) {
      ...
      models.ProcessedData.belongsTo(models.Users, {
      ...
      models.ProcessedData.belongsTo(models.DataFiles, {
        foreignKey: 'data_file_id',
        as: 'pDataFileRef',
        type: DataTypes.BIGINT
      });
      models.ProcessedData.belongsTo(models.AgeGroups, {
        foreignKey: 'age_group_id',
        as: 'AgeGroupRef',
        type: DataTypes.BIGINT
      })
      models.ProcessedData.belongsTo(models.Regions, {
        foreignKey: 'region_id',
        as: 'RegionRef',
        type: DataTypes.BIGINT
      })
      models.ProcessedData.belongsTo(models.Emotions, {
        foreignKey: 'emotion_id',
        as: 'EmotionRef',
        type: DataTypes.BIGINT
      })
      models.ProcessedData.belongsTo(models.DataQuality, {
        foreignKey: 'data_quality_id',
        as: 'DataQualityRef',
        type: DataTypes.BIGINT
      })
      models.ProcessedData.belongsTo(models.VideoTypes, {
